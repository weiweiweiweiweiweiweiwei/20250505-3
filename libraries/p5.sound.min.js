...
!function(n) {
    ...
    void 0 === (i = function() {
        ...
        function l(t, e) {
            ...
            this.isUndef(e) || 1 === e ? this.output = this.context.createGain() : 1 < e && (this.output = new Array(t))
        }
        var e;
        ...
        l.prototype.connect = function(t, e, n) {
            ...
            this.output[e].connect(t, 0, n)) : this.output.connect(t, e, n),
            this
        }
        ,
        l.prototype.disconnect = function(t, e, n) {
            ...
            this.output[e].disconnect(t, 0, n)) : this.output.disconnect.apply(this.output, arguments)
        }
        ,
        ...
        l.prototype.defaultArg = function(t, e) {
            if (this.isObject(t) && this.isObject(e)) {
                var n = {};
                for (var i in t)
                    n[i] = this.defaultArg(e[i], t[i]);
                for (var r in e)
                    n[r] = this.defaultArg(t[r], e[r]);
                return n
            }
...
, function(t, e, n) {
    ...
    void 0 === (r = function(e) {
        ...
        e.Signal.prototype.dispose = function() {
            return e.Param.prototype.dispose.call(this),
            this._param = null,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(u) {
        ...
        u.TimelineSignal.prototype.exponentialRampToValueAtTime = function(t, e) {
            ...
            t < this._minOutput ? (this._param.exponentialRampToValueAtTime(this._minOutput, e - this.sampleTime),
            this.setValueAtTime(0, e)) : this._param.exponentialRampToValueAtTime(t, e),
            this
        }
        ,
        ...
        u.TimelineSignal.prototype.setRampPoint = function(t) {
            ...
            if (n && n.time === t)
                ...
                i && (this.cancelScheduledValues(t),
                i.type === u.TimelineSignal.Type.Linear ? this.linearRampToValueAtTime(e, t) : i.type === u.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(e, t)),
        ...
        u.TimelineSignal.prototype.getValueAtTime = function(t) {
            ...
            if (null === n)
                ...
                i = n.type === u.TimelineSignal.Type.Curve ? this._curveInterpolate(n.time, n.value, n.duration, t) : null === e ? n.value : e.type === u.TimelineSignal.Type.Linear ? this._linearInterpolate(n.time, n.value, e.time, e.value, t) : e.type === u.TimelineSignal.Type.Exponential ? this._exponentialInterpolate(n.time, n.value, e.time, e.value, t) : n.value;
            return i
        }
        ,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(r) {
        ...
        r.Clock.prototype.start = function(t, e) {
            return t = this.toSeconds(t),
            this._state.getValueAtTime(t) !== r.State.Started && this._state.add({
        ...
        r.Clock.prototype._loop = function() {
            for (var t = this.now() + this.context.lookAhead + this.context.updateInterval + 2 * this.context.lag; t > this._nextTick && this._state; ) {
                ...
                if (e !== this._lastState) {
                    ...
                    e === r.State.Started ? (this._nextTick = n.time,
                    this.isUndef(n.offset) || (this.ticks = n.offset),
                    this.emit("start", n.time, this.ticks)) : e === r.State.Stopped ? (this.ticks = 0,
                    this.emit("stop", n.time)) : e === r.State.Paused && this.emit("pause", n.time)
                }
                var i = this._nextTick;
                this.frequency && (this._nextTick += 1 / this.frequency.getValueAtTime(this._nextTick),
                e === r.State.Started && (this.callback(i),
                this.ticks++))
            }
        }
        ,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(i) {
        function t(t, e, n) {
            if (t.input)
                Array.isArray(t.input) ? (i.prototype.isUndef(n) && (n = 0),
                this.connect(t.input[n])) : this.connect(t.input, e, n);
            else
                try {
        ...
        i.supported && (r = AudioNode.prototype.connect,
        o = AudioNode.prototype.disconnect,
        AudioNode.prototype.connect !== t && (AudioNode.prototype.connect = t,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(s) {
        ...
        s.Emitter.prototype.dispose = function() {
            return s.prototype.dispose.call(this),
            this._events = null,
            this
        }
        ,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(i) {
        "use strict";
        return i.SignalBase = function() {}
        ,
        i.extend(i.SignalBase),
        i.SignalBase.prototype.connect = function(t, e, n) {
            return i.Signal && i.Signal === t.constructor || i.Param && i.Param === t.constructor || i.TimelineSignal && i.TimelineSignal === t.constructor ? (t._param.cancelScheduledValues(0),
            t._param.value = 0,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(n) {
        ...
        n.Time.prototype.copy = function(t) {
            return n.TimeBase.prototype.copy.call(this, t),
    ...
    void 0 === (r = function(i) {
        return i.TimeBase = function(t, e) {
            ...
            t instanceof i.TimeBase)
                ...
                this.isString(t) ? this.set(t) : this.isUndef(t) && (this._expr = this._defaultExpr())
        }
        ,
        i.extend(i.TimeBase),
        ...
        i.TimeBase.prototype._primaryExpressions = {
            ...
            tr: {
                ...
                method: function(t, e, n) {
                    var i = 0;
                    return t && "0" !== t && (i += this._beatsToUnits(this._timeSignature() * parseFloat(t))),
        ...
        i.TimeBase.prototype._parseBinary = function(t, e) {
            ...
            for (var i = t.peek(); i && this._matchGroup(i, this._binaryExpressions, e); )
                n = (i = t.next()).method.bind(this, n, this._parseBinary(t, e - 1)),
                i = t.peek();
            return n
        }
        ,
        i.TimeBase.prototype._parseUnary = function(t) {
            ...
            i.method.bind(this, n)) : this._parsePrimary(t)
        }
        ,
        ...
        i.TimeBase.prototype._pushExpr = function(t, e, n) {
            return t instanceof i.TimeBase || (t = new this.constructor(t,n)),
...
, function(t, e, n) {
    ...
    void 0 === (r = function(i) {
        ...
        i.Param.prototype.setValueAtTime = function(t, e) {
            return t = this._fromUnits(t),
            (e = this.toSeconds(e)) <= this.now() + this.blockTime ? this._param.value = t : this._param.setValueAtTime(t, e),
            this
        }
        ,
        ...
        i.Param.prototype.setValueCurveAtTime = function(t, e, n) {
            ...
            return this._param.setValueCurveAtTime(t, this.toSeconds(e), this.toSeconds(n)),
            this
        }
        ,
        ...
        i.Param.prototype.rampTo = function(t, e, n) {
            return e = this.defaultArg(e, 0),
            this.units === i.Type.Frequency || this.units === i.Type.BPM || this.units === i.Type.Decibels ? this.exponentialRampToValue(t, e, n) : this.linearRampToValue(t, e, n),
            this
        }
        ,
        ...
        i.Param.prototype.dispose = function() {
            return i.prototype.dispose.call(this),
            this._param = null,
            this._lfo && (this._lfo.dispose(),
            this._lfo = null),
            this
...
, function(t, e, n) {
    ...
    void 0 === (r = function(e) {
        ...
        e.Timeline.prototype.forEachFrom = function(t, e) {
            for (var n = this._search(t); 0 <= n && this._timeline[n].time >= t; )
                n--;
            return this._iterate(e, n + 1),
            this
        }
...
, function(t, e, n) {
    ...
    void 0 === (r = function(e) {
        ...
        return e.CrossFade = function(t) {
            ...
            this.fade = new e.Signal(this.defaultArg(t, .5),e.Type.NormalRange),
...
, function(t, e) {
    ...
    var p, a;
    a = [],
    "function" != typeof AudioWorkletNode && (self.AudioWorkletNode = function(t, e, n) {
        var i = h(t)[e]
          , r = t.createScriptProcessor(void 0, 2, n && n.outputChannelCount ? n.outputChannelCount[0] : 2);
        if (r.parameters = new Map,
        i.properties)
        ...
        return fetch(t).then(function(t) {
            ...
            var n = {
              ...
              , i = new function(t, e) {
                ...
                n.style.cssText = "position:absolute;left:0;top:-999px;width:1px;height:1px;",
                e.appendChild(n);
            ...
            return i.exec((e && e.transpile || String)(t)),
            null
        })
    }
    ,
...
, function(t, e) {
    ...
    AudioContext.prototype.createBufferSource = function() {
        ...
        return i.start ? (i.internal_start = i.start,
...
, function(t, e, n) {
    ...
    void 0 === (r = function(u) {
        ...
        function n(t, e, n) {
            var i = new t;
            return n._eval(e[0]).connect(i, 0, 0),
        ...
        u.Expr.prototype._parseTree = function(t) {
            ...
            function a(t) {
                ...
                e = t < 0 ? function t() {
                    var e, n;
                    return o(e = i.peek(), "unary") ? (e = i.next(),
                    n = t(),
                    {
                        operator: e.value,
                        method: e.method,
...
, function(t, e, n) {
    ...
    function y(t) {
        ...
        return n instanceof ScriptProcessorNode && (e = n.bufferSize),
        n.disconnect(),
        n = null,
        e
    }
    ...
    void 0 !== S.createStereoPanner ? x = function() {
        ...
        function i(t, e, n) {
            ...
            1 < n ? (this.splitter = S.createChannelSplitter(2),
        ...
        return w(i, [{
            ...
            value: function(t) {
                ...
                this.input.connect(this.right)) : 2 === t && (void 0 === this.splitter && (this.splitter = S.createChannelSplitter(2)),
    ...
    var q = function() {
        function o(t, e, n, i) {
            ...
            this._clearOnEnd = function(t) {
                ...
                n._onended(n),
                n.bufferSourceNodes.map(function(t, e) {
                    return e
        ...
        return function(t, e, n) {
            ...
            value: function(t, e, n, i, r) {
                if (this.output) {
                    ...
                    "restart" === this.mode && this.buffer && this.bufferSourceNode && (this.bufferSourceNode.stop(a),
                    ...
                    "untildone" !== this.mode || !this.isPlaying()) {
                        ...
                        this._paused ? (this.bufferSourceNode.start(a, this.pauseTime, r),
                        this._counterNode.start(a, this.pauseTime, r)) : (this.bufferSourceNode.start(a, o, r),
            ...
            value: function(t) {
                ...
                this.isPlaying() && this.buffer && this.bufferSourceNode ? (this._paused = !0,
                this._playing = !1,
            ...
            value: function(t) {
                ...
                if (0 === (this.playbackRate = t) ? t = 1e-13 : t < 0 && !this.reversed ? (t = Math.abs(t),
                e = !0) : 0 < t && this.reversed && (e = !0),
            ...
            value: function() {
                var e = this
                  ...
                  , r = y(256);
                return n._workletNode && (n._workletNode.disconnect(),
                ...
                ,
                i.buffer = function(t) {
                    for (var e = t.length, n = R.createBuffer(1, t.length, R.sampleRate), i = n.getChannelData(0), r = 0; r < e; r++)
                        i[r] = r;
                    return n
                }(n.buffer),
    ...
    var B = function() {
        function e(t) {
            ...
            this._workletNode.port.onmessage = function(t) {
                "amplitude" === t.data.name && (this.volume = t.data.volume,
        ...
        return function(t, e, n) {
            ...
            value: function(t, e) {
                ...
                null == t ? p.meter.connect(this._workletNode) : t ? (t.connect(this._workletNode),
                this._workletNode.disconnect(),
                this._workletNode.connect(this.output)) : p.meter.connect(this._workletNode)
            }
        }, {
            key: "connect",
            value: function(t) {
    ...
    var j = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t) {
                ...
                p.fftMeter.disconnect()) : p.fftMeter.connect(this.analyser)
            }
        }, {
            key: "waveform",
            value: function() {
                for (var t, e, n = new Array, i = 0; i < arguments.length; i++)
                    "number" == typeof arguments[i] && (t = arguments[i],
                    this.analyser.fftSize = 2 * t),
            ...
            value: function(t, e) {
                ...
                e = this.bass[1]) : "lowMid" === t ? (t = this.lowMid[0],
                e = this.lowMid[1]) : "mid" === t ? (t = this.mid[0],
                e = this.mid[1]) : "highMid" === t ? (t = this.highMid[0],
                e = this.highMid[1]) : "treble" === t && (t = this.treble[0],
                e = this.treble[1]),
                "number" != typeof t)
                ...
                if (e) {
                    if (t && e) {
                        ...
                        for (var r = Math.round(t / n * this.freqDomain.length), o = Math.round(e / n * this.freqDomain.length), s = 0, a = 0, u = r; u <= o; u++)
                            s += this.freqDomain[u],
                            a += 1;
                        return s / a
                    }
            ...
            key: "smooth",
            value: function(t) {
                return void 0 !== t && (this.smoothing = t),
                this.smoothing
            }
        }, {
            key: "dispose",
            ...
            key: "linAverages",
            value: function(t) {
                for (var e = t || 16, n = this.freqDomain, i = n.length, r = Math.floor(i / e), o = new Array(e), s = 0, a = 0; a < i; a++)
    ...
    function $(t, e, n, i, r) {
        ...
        for (var s in t.mathOps)
            t.mathOps[s]instanceof r && (o.disconnect(),
            t.mathOps[s].dispose(),
            (n = s) < t.mathOps.length - 2 && (i = t.mathOps[s + 1]));
        return n === t.mathOps.length - 1 && t.mathOps.push(i),
        0 < s && (o = t.mathOps[s - 1]),
        o.disconnect(),
        o.connect(e),
        e.connect(i),
    ...
    var Q = function() {
        function r(t, e) {
            ...
            this.output.gain.setValueAtTime(.5, p.audiocontext.currentTime),
        ...
        return function(t, e, n) {
            ...
            value: function(t, e) {
                ...
                if (!this.started) {
                    ...
                    for (var o in this.oscillator && (this.oscillator.disconnect(),
            ...
            value: function(t, e, n) {
                ...
                if ("number" != typeof t || isNaN(t)) {
                    ...
                    this.f = t;
                    var o = p.audiocontext.currentTime;
                    0 === i ? this.oscillator.frequency.setValueAtTime(t, r + o) : 0 < t ? this.oscillator.frequency.exponentialRampToValueAtTime(t, r + i + o) : this.oscillator.frequency.linearRampToValueAtTime(t, r + i + o),
            ...
            value: function(t) {
                ...
                this.connection = t) : this.panner.connect(p.input)
            }
        }, {
            key: "disconnect",
            value: function() {
            ...
            value: function(t) {
                var e = p5.prototype.map(t, 0, 1, 0, 1 / this.f)
                  , n = p.audiocontext.currentTime;
                this.phaseAmount = t,
                this.dNode || (this.dNode = p.audiocontext.createDelay(),
            ...
            value: function(t, e, n, i) {
                var r, o;
                o = 4 === arguments.length ? (r = p5.prototype.map(n, t, e, 0, 1) - .5,
                p5.prototype.map(i, t, e, 0, 1) - .5) : (r = t,
                e);
                var s = new G.a(r,o);
      ...
      , K = function() {
        function e(t) {
            return Y(this, e),
            z(this, W(e).call(this, t, "triangle"))
        }
        return Z(e, Q),
        e
    }()
      , tt = function() {
        function e(t) {
            return Y(this, e),
            z(this, W(e).call(this, t, "sawtooth"))
        }
        return Z(e, Q),
        e
    }()
    ...
    p5.Envelope.prototype._init = function() {
        var t = p.audiocontext.currentTime;
        this.control.setTargetAtTime(1e-5, t, .001),
    ...
    p5.Envelope.prototype.triggerAttack = function(t, e) {
        ...
        !0 === this.isExponential ? this.control.exponentialRampToValueAtTime(this.checkExpInput(i), n) : this.control.linearRampToValueAtTime(i, n),
        n += this.aTime,
        !0 === this.isExponential ? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.aLevel), n),
        i = this.checkExpInput(this.control.getValueAtTime(n)),
        this.control.cancelScheduledValues(n),
        this.control.exponentialRampToValueAtTime(i, n)) : (this.control.linearRampToValueAtTime(this.aLevel, n),
        i = this.control.getValueAtTime(n),
        this.control.cancelScheduledValues(n),
        this.control.linearRampToValueAtTime(i, n)),
        n += this.dTime,
        !0 === this.isExponential ? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.dLevel), n),
        i = this.checkExpInput(this.control.getValueAtTime(n)),
        this.control.cancelScheduledValues(n),
        this.control.exponentialRampToValueAtTime(i, n)) : (this.control.linearRampToValueAtTime(this.dLevel, n),
        i = this.control.getValueAtTime(n),
        this.control.cancelScheduledValues(n),
        this.control.linearRampToValueAtTime(i, n))
    }
    ...
    p5.Envelope.prototype.triggerRelease = function(t, e) {
        if (this.wasTriggered) {
            ...
            !0 === this.isExponential ? this.control.exponentialRampToValueAtTime(this.checkExpInput(i), n) : this.control.linearRampToValueAtTime(i, n),
            n += this.rTime,
            !0 === this.isExponential ? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.rLevel), n),
            i = this.checkExpInput(this.control.getValueAtTime(n)),
            this.control.cancelScheduledValues(n),
            this.control.exponentialRampToValueAtTime(i, n)) : (this.control.linearRampToValueAtTime(this.rLevel, n),
            i = this.control.getValueAtTime(n),
            this.control.cancelScheduledValues(n),
            this.control.linearRampToValueAtTime(i, n)),
            this.wasTriggered = !1
    ...
    p5.Envelope.prototype.ramp = function(t, e, n, i) {
        ...
        a < o ? (this.control.setTargetAtTime(o, r, this._rampAttackTC),
        r += this._rampAttackTime) : o < a && (this.control.setTargetAtTime(o, r, this._rampDecayTC),
        r += this._rampDecayTime),
        void 0 !== s && (o < s ? this.control.setTargetAtTime(s, r, this._rampAttackTC) : s < o && this.control.setTargetAtTime(s, r, this._rampDecayTC))
    }
    ,
    p5.Envelope.prototype.connect = function(t) {
        ((this.connection = t)instanceof p5.Oscillator || t instanceof p5.SoundFile || t instanceof p5.AudioIn || t instanceof p5.Reverb || t instanceof p5.Noise || t instanceof p5.Filter || t instanceof p5.Delay) && (t = t.output.gain),
    ...
    var ht = function() {
        for (var t = 2 * p.audiocontext.sampleRate, e = p.audiocontext.createBuffer(1, t, p.audiocontext.sampleRate), n = e.getChannelData(0), i = 0; i < t; i++)
            n[i] = 2 * Math.random() - 1;
        return e.type = "white",
        e
    }()
    ...
    function wt() {
        for (var t = p.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), n = e.getChannelData(0), i = 0; i < 2048; i++)
            n[i] = 1;
    ...
    var xt = function() {
        function r(t, e) {
            ...
            return n.dNode.delayTime.value = i,
            n.dcGain.gain.value = 1.7 * (.5 - n.w),
            n.osc2.disconnect(),
    ...
    var kt = function() {
        function e(t) {
            ...
            window.MediaStreamTrack && window.navigator.mediaDevices && window.navigator.mediaDevices.getUserMedia || (t ? t() : window.alert("This browser does not support MediaStreamTrack and mediaDevices")),
            p.soundArray.push(this)
        }
        return function(t, e, n) {
            e && St(t.prototype, e),
            ...
            value: function(e, n) {
                ...
                window.navigator.mediaDevices.getUserMedia(r).then(function(t) {
                    i.stream = t,
                    i.enabled = !0,
    ...
    var Ct = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t, e, n) {
                ...
                this.output.gain.linearRampToValueAtTime(u, s + .001),
            ...
            key: "drywet",
            value: function(t) {
                return void 0 !== t && (this._drywet.fade.value = t),
    ...
    var Ft = function() {
        ...
        function(t, e, n) {
            ...
            value: function(t, e) {
                var n = e || 0;
                return t <= 0 && (t = 1),
                "number" == typeof t ? (this.biquad.frequency.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.biquad.frequency.exponentialRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.biquad.frequency),
            ...
            value: function(t, e) {
                ...
                this.biquad.Q.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.biquad.Q.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.biquad.Q),
                this.biquad.Q.value
            }
        }, {
            key: "gain",
            value: function(t, e) {
                ...
                this.biquad.gain.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.biquad.gain.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.biquad.gain),
            ...
            value: function() {
                ...
                !0 === this._on ? this.biquad.type = this._untoggledType : !1 === this._on && (this.biquad.type = "allpass"),
                this._on
            }
        }, {
            key: "setType",
      ...
      , Dt = function() {
        function t() {
            return qt(this, t),
            Nt(this, Vt(t).call(this, "lowpass"))
        }
        return jt(t, Ft),
        t
    }()
      , It = function() {
        function t() {
            return qt(this, t),
            Nt(this, Vt(t).call(this, "highpass"))
        }
        return jt(t, Ft),
        t
    }()
      , Ut = function() {
        function t() {
            return qt(this, t),
            Nt(this, Vt(t).call(this, "bandpass"))
        }
        return jt(t, Ft),
        t
    }()
    ...
    var ee = function() {
        ...
        function(t, e, n) {
            ...
            key: "dispose",
            value: function() {
                if (Jt(Kt(s.prototype), "dispose", this).call(this),
                this.bands) {
    ...
    var ie = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t, e) {
                ...
                this.listener.positionX.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.positionX.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.positionX),
            ...
            value: function(t, e) {
                ...
                this.listener.positionY.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.positionY.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.positionY),
            ...
            value: function(t, e) {
                ...
                this.listener.positionZ.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.positionZ),
                this.listener.positionZ.value
            }
        }, {
            key: "orient",
            value: function(t, e, n, i, r, o, s) {
                return 3 === arguments.length || 4 === arguments.length ? (s = i,
                this.orientForward(t, e, n, s)) : 6 !== arguments.length && 7 !== arguments || (this.orientForward(t, e, n),
            ...
            value: function(t, e) {
                ...
                this.listener.forwardX.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.forwardX.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.forwardX),
            ...
            value: function(t, e) {
                ...
                this.listener.forwardY.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.forwardY.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.forwardY),
            ...
            value: function(t, e) {
                ...
                this.listener.forwardZ.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.forwardZ.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.forwardZ),
            ...
            value: function(t, e) {
                ...
                this.listener.upX.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.upX.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.upX),
            ...
            value: function(t, e) {
                ...
                this.listener.upY.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.upY.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.upY),
            ...
            value: function(t, e) {
                ...
                this.listener.upZ.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.listener.upZ.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.listener.upZ),
    ...
    var le = function() {
        ...
        function(t, e, n) {
            ...
            value: function(t, e) {
                ...
                this.panner.positionX.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.positionX.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.positionX),
            ...
            value: function(t, e) {
                ...
                this.panner.positionY.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.positionY.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.positionY),
            ...
            value: function(t, e) {
                ...
                this.panner.positionZ.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.positionZ),
                this.panner.positionZ.value
            }
        }, {
            key: "orient",
            value: function(t, e, n, i) {
                return this.orientX(t, i),
                this.orientY(e, i),
                this.orientZ(n, i),
            ...
            value: function(t, e) {
                ...
                this.panner.orientationX.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.orientationX.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.orientationX),
            ...
            value: function(t, e) {
                ...
                this.panner.orientationY.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.orientationY.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.orientationY),
            ...
            value: function(t, e) {
                ...
                this.panner.orientationZ.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.panner.orientationZ.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : t && t.connect(this.panner.orientationZ),
    ...
    var ve = function() {
        function e() {
            ...
            t._leftFilter.biquad.Q.setValueAtTime(.3, t.ac.currentTime),
            t._rightFilter.biquad.Q.setValueAtTime(.3, t.ac.currentTime),
    ...
    var Ae = function() {
      ...
      , Oe = function() {
        function r(t, e, n) {
            ...
            i.input.gain.value = .5,
            t ? (i.impulses = [],
            i._loadBuffer(t, e, n)) : (i._seconds = 3,
            i._decay = 2,
            i._reverse = !1,
            i._buildImpulse()),
            i.impulses = [],
    ...
    var Fe = function() {
        ...
        return Be(n, [{
            ...
            value: function(t, e, n) {
                ...
                this.phrases.push(i),
                i.sequence.length > this.length && (this.length = i.sequence.length)
            }
        }, {
            key: "removePhrase",
            value: function(t) {
            ...
            value: function(t) {
                ...
                this.partStep += 1) : this.looping || this.partStep !== this.length - 1 || this.onended()
            }
        }, {
            key: "onStep",
            value: function(t) {
    ...
    var Ge = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t) {
                var e = t || 0
                  , n = p.audiocontext.currentTime;
                this.isPlaying || (this.clock.start(n + e),
                this.isPlaying = !0)
            }
        }, {
            key: "stop",
            value: function(t) {
                var e = t || 0
                  , n = p.audiocontext.currentTime;
                this.isPlaying && (this.clock.stop(n + e),
                this.isPlaying = !1)
            }
        }, {
            key: "pause",
            value: function(t) {
                var e = t || 0
                  , n = p.audiocontext.currentTime;
                this.isPlaying && (this.clock.pause(n + e),
                this.isPlaying = !1)
            }
        }, {
            key: "syncedStart",
    ...
    var He = function() {
        ...
        function(t, e, n) {
            ...
            value: function(t, e) {
                ...
                this.compressor.attack.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.compressor.attack.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : void 0 !== t && t.connect(this.compressor.attack),
            ...
            value: function(t, e) {
                ...
                this.compressor.knee.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.compressor.knee.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : void 0 !== t && t.connect(this.compressor.knee),
            ...
            value: function(t, e) {
                ...
                this.compressor.ratio.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.compressor.ratio.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : void 0 !== t && t.connect(this.compressor.ratio),
            ...
            value: function(t, e) {
                ...
                this.compressor.threshold.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.compressor.threshold.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : void 0 !== t && t.connect(this.compressor.threshold),
            ...
            value: function(t, e) {
                ...
                this.compressor.release.cancelScheduledValues(this.ac.currentTime + .01 + n),
                this.compressor.release.linearRampToValueAtTime(t, this.ac.currentTime + .02 + n)) : "undefined" != typeof number && t.connect(this.compressor.release),
    ...
    var Qe = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t) {
                ...
                e > this.cutoff && e > this.threshold && 0 < e - this.penergy ? (this._onPeak(),
                this.isDetected = !0,
    ...
    function un(t) {
        for (var e, n = "number" == typeof t ? t : 50, i = new Float32Array(44100), r = Math.PI / 180, o = 0; o < 44100; ++o)
            e = 2 * o / 44100 - 1,
    ...
    var cn = function() {
        function r(t, e) {
            ...
            return n.waveShaperNode = n.ac.createWaveShaper(),
            n.amount = i,
    ...
    var bn = function() {
        ...
        function(t, e, n) {
            ...
            value: function(t, e) {
                var n = e || 0;
                return void 0 !== t && this.oscillator.amp(t, n),
    ...
    var wn = function() {
        ...
        return function(t, e, n) {
            ...
            key: "update",
            value: function(t, e) {
                if (this.energy = t.getEnergy(this.freqLow, this.freqHigh) / 255,
                !1 === this.isDetected && this.energy - this.penergy > this.treshold) {
                    this.isDetected = !0,
                    this.callback ? this.callback(this.energy) : e && e(this.energy);
                    var n = this;
                    setTimeout(function() {
                        n.isDetected = !1
                    }, this.sensitivity)
    ...
    var Sn = function() {
        ...
        return function(t, e, n) {
            ...
            value: function(t, e, n) {
                ...
                this._voicesInUse.getValueAtTime(o) < this.maxVoices ? i = Math.max(~~this._voicesInUse.getValueAtTime(o), 0) : (i = this._oldest,
                ...
                if (this._voicesInUse.setValueAtTime(u + 1, o),
    ...
    p5.prototype._mathChain = function(t, e, n, i, r) {
        for (var o in t.mathOps)
            t.mathOps[o]instanceof r && (t.mathOps[o].dispose(),
            (n = o) < t.mathOps.length - 1 && (i = t.mathOps[o + 1]));
        return t.mathOps[n - 1].disconnect(),
    ...
    p5.prototype.createConvolver = function(t, e, n) {
        ...
        var i = this
          , r = new Oe(t,function(t) {
            ...
            "function" == typeof i._decrementPreload && i._decrementPreload()
        }
        ,n);
        return r.impulses = [],
        r
